...
# Create for Region if 'Region' exists
...
# Create for State if 'State' exists
...
# Create for City if 'City' exists
...
if 'Region' in df.columns and 'State' in df.columns and 'City' in df.columns:
